...
namespace API_DSCS2_WEBBANGIAY.Migrations
{
    ...
    [Migration("20221218032957_removeCasecadeTblMessage")]
    partial class removeCasecadeTblMessage
    {
            ...
            modelBuilder.Entity("API_DSCS2_WEBBANGIAY.Models.Message", b =>
                {
                    ...
                    b.Property<int?>("MessageNavigationID")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("userNavigationTenTaiKhoan")
                        .HasColumnType("char(20)");

                    b.HasKey("ID");

                    b.HasIndex("MessageNavigationID");

                    b.HasIndex("userNavigationTenTaiKhoan");
            ...
            modelBuilder.Entity("API_DSCS2_WEBBANGIAY.Models.Message", b =>
                {
                    b.HasOne("API_DSCS2_WEBBANGIAY.Models.Message", "MessageNavigation")
                        .WithMany("Messages")
                        .HasForeignKey("MessageNavigationID");

                    b.HasOne("API_DSCS2_WEBBANGIAY.Models.TaiKhoan", "userNavigation")
                        .WithMany("Messages")
                        .HasForeignKey("userNavigationTenTaiKhoan");
