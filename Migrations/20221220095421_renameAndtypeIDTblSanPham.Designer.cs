...
namespace API_DSCS2_WEBBANGIAY.Migrations
{
    ...
    [Migration("20221220095421_renameAndtypeIDTblSanPham")]
    partial class renameAndtypeIDTblSanPham
    {
            ...
            modelBuilder.Entity("API_DSCS2_WEBBANGIAY.Models.ChiTietPhieuNhap", b =>
                {
                    ...
                    b.Property<int?>("SanPhamDetailsNavigationIDSanPham")
                        .HasColumnType("int");

                    b.Property<string>("SanPhamDetailsNavigationMaSanPham")
                        .HasColumnType("char(10)");

                    b.Property<int?>("SanPhamDetailsNavigation_idSize")
                        .HasColumnType("int");

                    b.Property<string>("SanPhamDetailsNavigationmaMau")
                        .HasColumnType("char(20)");
                    ...
                    b.HasIndex("SanPhamDetailsNavigationmaMau", "SanPhamDetailsNavigationIDSanPham", "SanPhamDetailsNavigation_idSize", "SanPhamDetailsNavigationMaSanPham");
            ...
            modelBuilder.Entity("API_DSCS2_WEBBANGIAY.Models.SoLuongDetails", b =>
                {
                    ...
                    b.HasKey("maMau", "IDSanPham", "_idSize", "MaSanPham");
            ...
            modelBuilder.Entity("API_DSCS2_WEBBANGIAY.Models.ChiTietPhieuNhap", b =>
                {
                    ...
                    b.HasOne("API_DSCS2_WEBBANGIAY.Models.SoLuongDetails", "SanPhamDetailsNavigation")
                        .WithMany("ctpns")
                        .HasForeignKey("SanPhamDetailsNavigationmaMau", "SanPhamDetailsNavigationIDSanPham", "SanPhamDetailsNavigation_idSize", "SanPhamDetailsNavigationMaSanPham");
